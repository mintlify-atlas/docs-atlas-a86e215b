...
description: "When you drag a materialized file back onto a Canvas, Canvas Card-Materializer automatically restores its original card color from YAML frontmatter."
---
