...
description: "Materialization converts Canvas text nodes into permanent Markdown files, replacing each node with a file reference while preserving layout."
---
